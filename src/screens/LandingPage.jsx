...
import RetinaViewer3D from '../components/RetinaViewer3D';
...
export default function LandingPage({ onLoginClick }) {
  const workflowSteps = [
    {
      ...
      desc: 'Quick demographic & diabetes history intake in rural camps or clinics.',
      icon: UserCheck
    },
    {
      step: '02',
      title: 'Upload Fundus Image',
      desc: 'Capture fundus photography via portable or tabletop retinal camera.',
      icon: UploadCloud
    },
    {
      step: '03',
      title: 'AI Analysis',
      desc: 'Instant deep-learning segmentation of lesions, exudates, and vessels.',
      icon: Cpu
    },
    {
      step: '04',
      title: 'Severity Assessment',
      desc: 'Standardized ICDR grading from No DR up to Proliferative DR.',
      icon: BarChart3
    },
    {
      step: '05',
      title: 'Prioritize Patient',
      desc: 'High-risk and critical cases flagged immediately for urgent doctor review.',
      icon: ShieldCheck
    },
    {
      step: '06',
      title: 'Track Screening History',
      desc: 'Longitudinal EHR timeline monitoring progression and treatment outcomes.',
      icon: History
    },
  ];
  ...
  const benefits = [
    {
      icon: Clock,
      title: 'Faster Camp Screening',
      desc: 'Complete fundus image intake and automated AI quality check in under 60 seconds per patient.',
      badge: 'High Throughput'
    },
    {
      icon: Zap,
      title: 'AI-Assisted Prioritization',
      desc: 'Instantly segregates mild routine cases from sight-threatening proliferative DR requiring immediate laser/anti-VEGF referral.',
      badge: 'Zero Delay'
    },
    {
      icon: Eye,
      title: 'Early Attention Identification',
      desc: 'Detects microaneurysms and subclinical macular changes before irreversible vision impairment develops.',
      badge: 'Preventive Care'
    },
    {
      icon: History,
      title: 'Longitudinal Screening History',
      desc: 'Secure patient record storage allowing year-over-year comparison of retinal vascular progression.',
      badge: 'EHR Integrated'
    },
    {
      icon: Tent,
      title: 'Designed for Rural Screening Camps',
      desc: 'Optimized for low-bandwidth environments, field laptops, and portable non-mydriatic fundus cameras.',
      badge: 'Field Ready'
    },
    {
      icon: HeartHandshake,
      title: 'Clinical Empowerment',
      desc: 'Enables optometrists and health workers to bridge the specialist doctor gap across underserved districts.',
      badge: 'Bridging Gaps'
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-teal-50/50 via-white to-slate-50 text-slate-900 overflow-hidden">
      ...
      <section className="relative pt-8 pb-10 md:pt-12 md:pb-16 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="absolute top-10 left-1/2 -translate-x-1/2 w-3/4 h-80 bg-gradient-to-r from-teal-200/30 via-cyan-200/30 to-emerald-200/30 blur-3xl -z-10 rounded-full pointer-events-none"></div>
        ...
        <div className="text-center max-w-4xl mx-auto mb-10">
          ...
          <div className="mt-8 flex flex-wrap items-center justify-center gap-4">
            <button
              ...
              className="px-8 py-3.5 rounded-full text-sm sm:text-base font-bold text-white bg-teal-600 hover:bg-teal-700 active:bg-teal-800 shadow-lg shadow-teal-600/25 transition-all hover:scale-[1.02] flex items-center gap-2.5"
            >
            ...
            <a
              href="#how-it-works"
              className="px-7 py-3.5 rounded-full text-sm sm:text-base font-semibold text-slate-700 bg-white/90 hover:bg-white border border-slate-200 shadow-sm hover:border-teal-300 transition-all"
            >
              How It Works
            </a>
          </div>
        ...
        {/* Eye/Retina AI Visualization (Replacing 3D Brain as per reference) */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center max-w-3xl mx-auto mb-14">
            ...
            <p className="text-sm sm:text-base text-slate-600 mt-3">
              A streamlined 6-step screening workflow engineered for high-volume rural health camps and clinical ophthalmic practices.
            </p>
          </div>

          {/* Sequential 6-Step Workflow Grid */}
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {workflowSteps.map((step, idx) => {
              ...
              return (
                <div 
                  key={step.step}
                  className="relative p-6 rounded-3xl bg-slate-50/80 border border-slate-200/80 hover:bg-white hover:border-teal-300 hover:shadow-card transition-all group"
                >
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <span className="text-2xl font-black text-slate-300 font-mono group-hover:text-teal-500 transition-colors">
                      {step.step}
                    </span>
                  </div>
      ...
      <section id="benefits" className="py-16 md:py-24 bg-gradient-to-b from-slate-50 to-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-14">
            ...
            <p className="text-sm sm:text-base text-slate-600 mt-3">
              Engineered specifically to solve the clinical screening bottlenecks faced in remote rural healthcare missions.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {benefits.map((benefit, idx) => {
              ...
              return (
                <div
                  key={idx}
                  className="p-6 rounded-3xl bg-white border border-slate-200/80 shadow-soft hover:shadow-card hover:border-teal-300 transition-all flex flex-col justify-between"
                >
                  <div>
                    <div className="flex items-center justify-between mb-4">
      ...
      {/* Clinical Safety & Medical Disclaimer Section */}
      <section id="disclaimer" className="py-12 bg-slate-100/70 border-t border-slate-200">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
          <div className="p-5 rounded-2xl bg-white border border-slate-200 shadow-sm flex flex-col sm:flex-row items-center gap-4 text-left">
            ...
            <div>
              <h4 className="text-xs font-bold uppercase tracking-wider text-slate-800">
                Medical & Clinical Safety Disclaimer
              </h4>
          ...
          {/* Access Portal CTA at bottom */}
          <div className="mt-8">
            <button
              onClick={onLoginClick}
              className="px-8 py-3 rounded-full text-sm font-bold text-white bg-teal-600 hover:bg-teal-700 shadow-md shadow-teal-600/20 transition-all inline-flex items-center gap-2"
            >
      ...
      <footer className="py-8 bg-white border-t border-slate-200 text-slate-500 text-xs">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <p className="text-slate-400">Adhering to ICDR Standards • Built for Camp & Hospital Operations</p>
        </div>
      </footer>
